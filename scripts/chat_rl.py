...
@torch.no_grad()
def get_batch():
    assistant_end = tokenizer.encode_special("<|end|>") # ok to use this token, it's only for padding and isn't used in the loss.
    ...
    for example_idx in itertools.cycle(rank_indices):
        ...
        # (i.e. keep the <|start|>, but delete everything after it)
