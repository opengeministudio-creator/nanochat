...
class Engine:
    ...
    def generate(self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42):
        ...
        python_start = get_special("<|start_python|>")
        python_end = get_special("<|end_python|>")
        output_start = get_special("<|start_output|>")
        output_end = get_special("<|end_output|>")
        assistant_end = get_special("<|end_assistant|>") # if sampled, ends row
        ...
        while True:
            ...
            for i, state in enumerate(row_states):
                ...
                # On <|end_assistant|> or <|start|>, mark the row as completed
    ...
    def generate_batch(self, tokens, num_samples=1, **kwargs):
        ...
        """
        assistant_end = self.tokenizer.encode_special("<|end_assistant|>")
